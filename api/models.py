...
class Teacher(models.Model):
    ...
    fri_begin = models.IntegerField(blank=True, null=True)
    fri_end = models.IntegerField(blank=True, null=True)
    sat_morning = models.IntegerField(blank=True, null=True, default=1)
    sat_afternoon = models.IntegerField(blank=True, null=True, default=1)
    sat_evening = models.IntegerField(blank=True, null=True, default=1)
    sun_morning = models.IntegerField(blank=True, null=True, default=1)
    sun_afternoon = models.IntegerField(blank=True, null=True, default=1)
