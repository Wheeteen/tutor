    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weekend_tutor_length', models.IntegerField(null=True, blank=True)),
                ('teacher_sex', models.IntegerField(null=True, blank=True)),
                ('teacher_method', models.TextField(null=True, blank=True)),
                ('learning_phase', models.IntegerField(null=True, blank=True)),
                ('class_field', models.IntegerField(null=True, db_column='class', blank=True)),
                ('grade', models.IntegerField(null=True, blank=True)),
                ('require', models.TextField(null=True, blank=True)),
                ('salary', models.DecimalField(null=True, max_digits=20, decimal_places=2, blank=True)),
                ('allowance_not', models.IntegerField(null=True, blank=True)),
